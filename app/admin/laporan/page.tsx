...
export default function AdminLaporanPage() {
  ...
  return (
    <AppLayout
      ...
      subtitle="Dokumen resmi rekapitulasi evaluasi dan ranking MOORA untuk pimpinan"
      user={{ nama: 'Administrator SPK', username: 'admin', role: 'ADMIN' }}
    >
      <div className="space-y-6">
        {/* Selector & Download PDF Toolbar */}
        ...
        {/* Lembar Laporan Ber-Kop Surat yang akan diexport ke PDF */}
        <div
          ref={reportRef}
