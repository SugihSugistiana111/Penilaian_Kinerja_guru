...
export default function AdminPenilaianPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (penData.rekap?.length > 0 && !selectedGuru) {
        ...
        // nilaiPerKriteria dari API menggunakan kode kriteria sebagai key
        // kita perlu konversi ke kriteriaId sebagai key untuk form
  ...
  return (
    <AppLayout
      title="Pencatatan Penilaian Kinerja Guru"
      subtitle="Kelola dan rekap nilai 4 kriteria evaluasi guru untuk komputasi MOORA"
        ...
        <div className="p-4 bg-white rounded-xl border border-hijau-muda flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs text-teks-sekunder">
              Status: <strong className="text-teks-utama">{dinilaiCount} dari {rekapGuru.length} guru</strong> dinilai
            </span>
            <Link
              href="/admin/moora"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 bg-white rounded-xl border border-hijau-muda overflow-hidden flex flex-col h-[560px]">
            <div className="p-3 border-b border-hijau-muda bg-hijau-soft flex items-center justify-between">
              ...
              <span className="text-[11px] text-teks-sekunder">Pilih untuk input nilai</span>
            </div>
          ...
          {/* Kolom Kanan: Form Penilaian Terstruktur */}
          <div className="lg:col-span-8 bg-white rounded-xl border border-hijau-muda p-6 space-y-6">
            {!selectedGuru ? (
              <div className="p-12 text-center text-xs text-teks-sekunder">
                Silakan pilih guru di sebelah kiri untuk mengisi atau memperbarui penilaian.
              </div>
            ) : (
              <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="Tuliskan catatan evaluasi kinerja..."
