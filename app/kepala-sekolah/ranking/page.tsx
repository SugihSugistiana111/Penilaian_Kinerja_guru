...
export default function KepsekRankingPage() {
  ...
  return (
    <AppLayout
      ...
      subtitle="Pemeringkatan rekomendasi keputusan kinerja guru SMA Al-Ihsan"
        ...
        <div className="bg-white rounded-xl border border-hijau-muda overflow-hidden">
          <div className="p-4 border-b border-hijau-muda flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-sm text-teks-utama">Daftar Peringkat Kinerja Guru</h3>
            </div>
