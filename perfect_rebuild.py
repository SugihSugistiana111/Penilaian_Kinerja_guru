...
def perfect_rebuild():
    ...
    # 1. Remove ALL existing "Gambar 4." captions in BAB IV
    for elem in list(body):
        ...
        if tag == 'p':
            ...
            # Check if this paragraph is in BAB IV (after "BAB IV" heading)
    ...
    # 2. Find all drawings in BAB IV (after element 700)
    drawings = []
    for elem in list(body):
        xml_s = etree.tostring(elem).decode('utf-8', errors='ignore')
    ...
    print(f"Total drawings found in BAB IV: {len(drawings)}")
