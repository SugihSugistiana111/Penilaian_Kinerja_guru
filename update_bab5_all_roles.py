...
def build_full_bab5_all_roles():
    ...
    # -------------------------------------------------------------
    # 5.4 Implementasi Sistem (Gambar 5.12 s.d. Gambar 5.26)
    # -------------------------------------------------------------
    ...
    sys_sections = [
        ...
        {
            "num": "5.4.11",
            "title": "Implementasi Antarmuka Dashboard Kepala Sekolah",
            "desc": "Implementasi antarmuka Dashboard Kepala Sekolah berfungsi sebagai pusat monitoring evaluasi kinerja guru dan pengesahan rekomendasi keputusan metode MOORA bagi pimpinan sekolah. Halaman ini memuat ringkasan 4 kartu statistik progres evaluasi guru, grafik kesiapan data, podium 3 besar rekomendasi guru berkinerja terbaik, serta menu navigasi khusus evaluator. Tampilan antarmuka Dashboard Kepala Sekolah disajikan pada Gambar 5.22.",
            "img": "system_screenshots/img_sys_kepsek_01_dashboard.png",
            "seq_num": 22,
            "cap_text": "Implementasi Antarmuka Dashboard Kepala Sekolah"
        },
        {
            "num": "5.4.12",
            "title": "Implementasi Antarmuka Form Transaksi Penilaian Kinerja Guru oleh Kepala Sekolah",
            "desc": "Implementasi antarmuka Form Transaksi Penilaian Kinerja Guru digunakan secara khusus oleh Kepala Sekolah untuk menginput nilai evaluasi terhadap setiap guru pada periode aktif. Form ini memuat ringkasan identitas dan beban mengajar guru, opsi pemilihan skor rubrik skala 1 sampai 5 untuk kriteria C1 s.d. C4, serta area catatan rekomendasi kualitatif pembinaan. Tampilan antarmuka Form Penilaian disajikan pada Gambar 5.23.",
            "img": "system_screenshots/img_sys_07_form_penilaian.png",
            "seq_num": 23,
            "cap_text": "Implementasi Antarmuka Form Transaksi Penilaian Kinerja Guru oleh Kepala Sekolah"
        },
        {
            "num": "5.4.13",
            "title": "Implementasi Antarmuka Monitoring & Analisis Kinerja Guru",
            "desc": "Implementasi antarmuka Monitoring Kinerja Guru digunakan oleh Kepala Sekolah untuk menganalisis grafik perkembangan nilai kompetensi dan nilai preferensi MOORA guru dari satu periode ke periode berikutnya. Halaman ini menyediakan pilihan selektor guru dan visualisasi grafik garis tren ketercapaian kriteria C1, C2, C3, dan C4 secara komparatif. Tampilan antarmuka Monitoring Kinerja Guru disajikan pada Gambar 5.24.",
            "img": "system_screenshots/img_sys_kepsek_02_monitoring.png",
            "seq_num": 24,
            "cap_text": "Implementasi Antarmuka Monitoring & Analisis Kinerja Guru"
        },
        ...
        # C. Guru
        {
            ...
            "desc": "Implementasi antarmuka Dashboard & Profil Mandiri Guru berfungsi sebagai portal mandiri bagi tenaga pendidik (guru) untuk melihat ringkasan biodata profil kedinasan, beban jam mengajar, kartu perolehan skor kriteria (C1-C4), hasil nilai akhir preferensi Yi dan posisi ranking mandiri, serta catatan umpan balik evaluasi dari Kepala Sekolah. Tampilan antarmuka Dashboard & Profil Mandiri Guru disajikan pada Gambar 5.25.",
        ...
        {
            "num": "5.4.15",
            "title": "Implementasi Antarmuka Riwayat & Arsip Evaluasi Kinerja Guru",
            "desc": "Implementasi antarmuka Riwayat & Arsip Evaluasi Kinerja Guru menyajikan arsip historis penilaian kinerja mandiri guru dari seluruh periode evaluasi yang telah terlaksana. Tabel riwayat memuat rincian capaian skor per kriteria, nilai preferensi MOORA, posisi peringkat pada setiap periode, serta catatan evaluasi Kepala Sekolah. Tampilan antarmuka Riwayat Evaluasi Guru disajikan pada Gambar 5.26.",
            "img": "system_screenshots/img_sys_guru_01_riwayat.png",
            "seq_num": 26,
            "cap_text": "Implementasi Antarmuka Riwayat & Arsip Evaluasi Kinerja Guru"
        }
    ]
